...
BEGIN
  ...
  -- 4. Registrar movimentação com tipo_ajuste_id e preco_aplicado atomicamente
  INSERT INTO estoque_movimentacoes (
    user_id, item_id, local_id, tipo, quantidade, motivo,
    estoque_antes, estoque_depois, tipo_ajuste_id, preco_aplicado
  )
  VALUES (
    v_auth_uid, p_item_id, p_local_id, v_tipo_mov, ABS(v_diferenca), p_motivo,
    v_estoque_atual.quantidade, p_nova_quantidade, p_tipo_ajuste_id, p_preco_aplicado
  );
