...
const templates = [
  ...
  },
  {
    ...
    icon: RefreshCw,
    mensagem: 'Olá [Nome], aqui é o Emerson da Delookii Jeans. Notei que faz tempo que não nos visitamos! Chegaram novidades da categoria que você gosta. Posso te enviar o catálogo?',
  },
];
