      ...
      <main className={cn("flex-1 flex flex-col h-screen overflow-hidden", isMobile && "pt-14 pb-[calc(80px+env(safe-area-inset-bottom,0px))]")}>
        ...
        <ScrollArea className="flex-1 overflow-hidden">
          <div className={cn("p-4 space-y-4", !isMobile && "p-6 space-y-6", isMobile && "pb-6")}>
            ...
            {/* Resumo do Período */}
            <div className={cn("grid gap-3 overflow-hidden", isMobile ? "grid-cols-2" : "grid-cols-4")}>
            ...
            <CargasAtivasAlerta cargasAtivas={todasCargasAtivas || []} onRegistrarRetorno={handleOpenRetornoFromHistorico} onEditarCarga={hasPermission('feira.edit') && !isVendedor ? handleEditarCarga : undefined} onGerarPDF={hasPermission('feira.generate_pdf') ? handleOpenPDFOptions : undefined} periodoEhHoje={periodoEhHoje} isGeneratingPDF={generatingPDFId !== null} />
        ...
        <DialogContent className="max-w-sm">
          ...
          <div className="space-y-4 py-4">
            <div className="flex items-center justify-between space-x-3 p-3 rounded-lg border bg-muted/30">
              ...
              <Switch id="hide-financials" checked={hideFinancials} onCheckedChange={setHideFinancials} />
            </div>
          </div>
